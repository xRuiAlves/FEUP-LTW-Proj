INSERT INTO User (user_id, user_username, user_realname, user_password, user_bio) VALUES (1, 'dicas', 'Rui', 'password1234', 'Gosto muito de pasteis de nata!');
INSERT INTO User (user_id, user_username, user_realname, user_password, user_bio) VALUES (2, 'dilipaFurao', 'Filipa', 'olaola', 'Gosto de chocolate!');
INSERT INTO User (user_id, user_username, user_realname, user_password, user_bio) VALUES (3, 'limalimao', 'Henrique', 'naoGostoDeESOF', 'Nao gosto de BDAD');
INSERT INTO User (user_id, user_username, user_realname, user_password, user_bio) VALUES (4, 'angelico', 'Angelo', 'mexicano', 'salsaTequilla');
...
INSERT INTO Comment (comment_id, votable_entity_id, comment_content) VALUES (1, 1, 'Gostei imenso deste texto!');
INSERT INTO Comment (comment_id, votable_entity_id, comment_content) VALUES (2, 2, 'Que fotos horríveis');
INSERT INTO Comment (comment_id, votable_entity_id, comment_content) VALUES (3, 3, 'Discordo plenamente!');
INSERT INTO Comment (comment_id, votable_entity_id, comment_content) VALUES (4, 4, 'Que saudades dessa cidade!');

INSERT INTO Story (story_id, votable_entity_id, story_title, story_content, story_creation_date) VALUES (1, 5, 'Viagem a Paris', 'Paris é mesmo bonito bla bla bla bla bla bla bla bla bla', '20170801');
INSERT INTO Story (story_id, votable_entity_id, story_title, story_content, story_creation_date) VALUES (2, 6, 'Porto!', ' bla bla bla bla bla bla bla bla bla', '20160427');
INSERT INTO Story (story_id, votable_entity_id, story_title, story_content, story_creation_date) VALUES (3, 7, 'Alemanha!', ' bla bla bla bla bla bla bla bla bla', '20180823');
INSERT INTO Story (story_id, votable_entity_id, story_title, story_content, story_creation_date) VALUES (4, 8, 'Espanha!', ' bla bla bla bla bla bla bla bla bla', '20160330');
